  ...
  <div class="card">
    ...
    <ul class="lists">
      <li class="list">
        ...
        <p v-if="field_id==''">No hay campos reservados</p> <p v-else>Campo de reserva: {{ field_id }}</p>
      </li>
      <li class="list">
        <svg class="icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          <g stroke-width="0" id="SVGRepo_bgCarrier"></g>
        ...
        <p v-if="startHour==''">No hay hora de inicio</p> <p v-else>Hora de inicio: {{ startHour }}</p>
      </li>
      <li class="list">
        <svg class="icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          <g stroke-width="0" id="SVGRepo_bgCarrier"></g>
        ...
        <p v-if="end_hour==''">No hay hora de final</p> <p v-else>Hora de fin: {{ end_hour }}</p>
      </li>
      <li class="list">
        <svg class="icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          <g stroke-width="0" id="SVGRepo_bgCarrier"></g>
        ...
        <p v-if="date==''">No hay fecha</p> <p v-else>Fecha: {{ date }}</p>
      </li>
    </ul>
