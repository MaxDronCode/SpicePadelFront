...
export default {
    ...
    methods: {
        ...
        async obtainName() {
            try {
                const response = await fetch('https://Test2php-env.eba-tdje93tb.us-east-1.elasticbeanstalk.com/spicepadel_api/api/getName.php', {
                    method: 'POST',
        ...
        async obtainInfoMatch() {
            try {
                const response = await fetch('http://Test2php-env.eba-tdje93tb.us-east-1.elasticbeanstalk.com/spicepadel_api/api/getUserTournaments.php', {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
                    body: JSON.stringify({
                        'dni': this.dni_player
